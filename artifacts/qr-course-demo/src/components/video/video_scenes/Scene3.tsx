    ...
    >
      ...
      <div className="w-1/2 h-full border-r border-border p-12 overflow-hidden flex flex-col relative opacity-50">
        ...
        <div className="prose prose-sm max-w-none text-foreground/80 space-y-6">
          ...
          <p>Physics is the study of how the physical world works at its most fundamental level — matter, motion, energy, and the forces that govern them. It is not about advanced math; it is about understanding why things happen the way they do.</p>
        </div>
      </div>
        ...
        <div className="flex-1 p-8 relative flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto space-y-6 flex flex-col">
            ...
            {phase >= 3 && (
              ...
              >
                <StreamingText text="Great question. Speed is how fast you're moving — just a number, like 30 m/s. Velocity adds direction — 30 m/s north. Two cars can share the same speed but have different velocities if they head different ways. Always ask 'how fast, and in what direction?' before describing motion." delay={0} />
              </motion.div>
            )}
          </div>
          ...
          <div className="mt-6 w-full min-h-24 border border-border rounded-xl bg-background p-3 flex items-end shadow-inner relative z-10">
            <div className="w-full flex justify-between items-center pr-2">
              <div className="text-foreground text-[15px] font-medium pl-2 relative w-full h-full flex items-center">
                {phase === 1 && <TypewriterText text="What's the difference between speed and velocity?" speed={25} />}
                {phase >= 2 && phase < 4 && <span className="text-muted-foreground font-normal">Ask a question about conceptual physics...</span>}
