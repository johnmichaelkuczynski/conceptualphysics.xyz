        ...
        {phase >= 2 && phase < 5 ? (
            ...
            <div className="space-y-4">
              ...
              >
                <div>
                  ...
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.1 — Motion, frames, and forces</h4>
              ...
              >
                <div>
                  <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Homework</div>
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.2 — Newton's laws, momentum, and energy</h4>
          ...
          >
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 mb-6 relative overflow-hidden">
              ...
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q1. A 2 kg cart is pushed with a net force of 10 newtons. What is its acceleration, in m/s²?</h3>
              
              <div className="w-fit mb-6">
                <div className="text-xs text-muted-foreground mb-2">Your answer:</div>
                <div className="px-6 py-3 bg-muted/30 border border-border rounded-lg text-lg font-mono">5 m/s²</div>
              </div>
                ...
                {phase >= 6 && (
                  ...
                  >
                    ...
                    <div className="text-sm text-blue-900 leading-relaxed">
                      <StreamingText text="Correct. By Newton's second law, a = F ÷ m = 10 N ÷ 2 kg = 5 m/s². Net force produces acceleration in proportion to the force and inversely to the mass." delay={0} />
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 opacity-50">
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q2. A 1500 kg car accelerates at 3 m/s². What net force is required, in newtons?</h3>
