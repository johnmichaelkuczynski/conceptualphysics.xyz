...
**The Conceptual Physics Studio — A Four-Week College Course That Teaches, Tutors, and Proofs Itself**

---

## 🧩 Overview

Physics Think is a self-paced, single-user web course that delivers a full month of college-freshman Conceptual Physics — taught, tutored, drilled, and graded entirely by AI, with built-in academic-integrity enforcement.

It compresses the experience of a semester-style conceptual-physics class into one focused product: read the lecture at the depth you want, ask a tutor scoped to the exact section you're on, drill problems whose difficulty adapts to you in real time, and submit homework, tests, a midterm, and a final that are AI-graded with feedback and screened for AI-generated answers.

Designed for **students, instructors evaluating AI-taught coursework, and researchers studying AI academic integrity**, Physics Think pairs a real curriculum with two layers of AI-authorship detection — surfacing not just *whether* the writing looks AI-generated, but whether the *act of producing it* did.
...
Physics Think reframes an AI-taught course as a *closed accountability loop*.
